...
public static class Globals
{
    ...
    public static string NATIVEDLL => $@"{AppDomain.CurrentDomain.BaseDirectory}\Native.dll";
    public static string NEWDLLPATH (string name) => @$"{AppDomain.CurrentDomain.BaseDirectory}\{name}_new.dll";
